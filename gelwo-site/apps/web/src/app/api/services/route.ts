 ...
 * Falls back to static seed data when DB is unavailable (development).
 */
...
// ─── Static seed data (used when DB not connected) ─────────────────────────
// This matches the service architecture from blueprint Section 10.
export const SERVICES_SEED = [
  {
    ...
    shortDescription:
      'Build web applications, enterprise platforms, mobile apps, and custom software systems designed around your workflow.',
    longDescription:
      'From internal business tools to customer-facing platforms, GELWO designs and builds software that fits the exact way your team works. We cover the full stack — from database architecture to polished user interfaces.',
    category: 'Technology',
    icon: '💻',
    heroImage: null,
    gallery: [],
  ...
  },
  {
    ...
    shortDescription:
      'Integrated Enterprise Resource Planning, inventory management, HR, CRM, finance, and multi-department workflow systems.',
    longDescription:
      'GELWO builds end-to-end business systems that connect every department. From procurement and inventory to HR and finance — all in one system your team can actually use.',
    category: 'Enterprise',
    icon: '⚙️',
    heroImage: null,
    gallery: [],
  ...
  },
  {
    ...
    shortDescription:
      'AI avatars, custom RAG knowledge bases, automated quote assistants, intelligent customer support, and predictive analytics.',
    longDescription:
      'We help businesses leverage artificial intelligence to automate repetitive work, enhance customer experiences, and make smarter decisions. From chatbots to predictive analytics, we build AI that fits your context.',
    category: 'AI Layer',
    icon: '🤖',
    heroImage: null,
    gallery: [],
    ...
    features: [
      ...
      'Automated Quotation Engines',
      'Predictive Analytics',
      'Process Automation (RPA)',
      'AI-Powered Customer Support',
    ],
    benefits: [
      '24/7 customer service without human agents',
  ...
  },
  {
    ...
    shortDescription:
      'High-speed fiber networks, biometric access control, commercial CCTV, server installations, and cloud architecture.',
    longDescription:
      'GELWO designs and installs enterprise-grade ICT infrastructure. From fiber networks to CCTV systems, we build the digital backbone your business needs to operate securely and at scale.',
  ...
  },
  {
    ...
    shortDescription:
      'Commercial & industrial solar microgrids, battery backup systems, hybrid power plants, and off-grid institutional power.',
    longDescription:
      'GELWO designs, supplies and installs commercial and industrial solar energy systems. From 10kW rooftop installations to 1MW+ microgrids — we provide reliable, cost-effective clean power.',
  ...
  },
  {
    ...
    shortDescription:
      'NCA certified structural construction, commercial remodeling, site planning, structural engineering, and infrastructure.',
    longDescription:
      'GELWO\'s NCA-certified construction division delivers institutional-grade construction projects — from commercial buildings to infrastructure installations. We combine engineering excellence with modern project management.',
    ...
    features: [
      ...
      'Commercial Renovation & Remodeling',
    ...
    benefits: [
      'NCA certified for quality assurance',
...
export async function GET() {
  try {
    ...
    const services = await db.service.findMany({
      where: { active: true },
      include: { gallery: { orderBy: { order: 'asc' } }, category: true },
      orderBy: { featured: 'desc' },
    });
    return NextResponse.json({ services });
  } catch {
    // Fall back to seed data (no DB connection or schema not migrated yet)
